                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="right-caption">
                        ...
                        <div class="section-tittle section-tittle2">
                            <span>Mari Berkenalan Dengan Kami</span>
                            <h2>{{ $about->judul }}</h2>
                        </div>
                        <div class="support-caption">
                            <p class="pera-top">{{ $about->sub_judul }}</p>
                            <p>{!! $about->deskripsi !!}</p>
                            <a href="/job_listing" class="btn post-btn">Lihat Pekerjaan</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6">
                    <div class="support-location-img">
                        <img src="{{ asset('about/'.$about->gambar) }}" alt="">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="home-blog-single mb-30">
                        <div class="blog-img-cap">
                            ...
                            <div class="blog-cap">
                                <p>|   Properties</p>
                                <h3><a href="{{ asset('TEMPLATE/single-blog.html') }}">Footprints in Time is perfect House in Kurashiki</a></h3>
