        ...
        <form action="/admin/kategori/store" method="POST">
            ...
            <div class="row">
                <div class="col-lg-8 mb-3">
                    ...
                    <input id="nama_kategori" type="text" class="form-control @error('nama_kategori') is-invalid @enderror" name="nama_kategori" value="{{ old('nama_kategori') }}" autocomplete="name">
