        ...
        <form action="/admin/kategori/update/{{ $kategori->id }}" method="POST">
            ...
            <div class="row">
                <div class="col-lg-8 mb-3">
                    <label for="nama_kategori" class="col-md-4 col-form-label">{{ __('Nama Kategori') }}</label>
                    <input id="nama_kategori" type="text" class="form-control @error('nama_kategori') is-invalid @enderror" name="nama_kategori" value="{{ $kategori->nama_kategori }}" autocomplete="name">
