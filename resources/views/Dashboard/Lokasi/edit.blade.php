...
<div class="container-fluid">
    <div class="container-fluid">
        <form action="/admin/lokasi/update/{{ $lokasi->id }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-8 mb-3">
                    <label for="nama_lokasi" class="col-md-4 col-form-label">{{ __('Nama Lokasi') }}</label>
                    <input id="nama_lokasi" type="text" class="form-control @error('nama_lokasi') is-invalid @enderror" name="nama_lokasi" value="{{ $lokasi->nama_lokasi }}" autocomplete="nama_lokasi">
